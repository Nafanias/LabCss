...
}`,s(t,e)},$$slots:{default:!0}});var T=r(R,4);u(T,{id:"stringifyingJavaScript",children:(t,a)=>{var e=$e();s(t,e)},$$slots:{default:!0}});var J=r(T,2),ae=r(c(J));v(ae,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-json-stringify-method/",children:(t,a)=>{o();var e=l("JSON.stringify()");s(t,e)},$$slots:{default:!0}}),o(),$(J);var D=r(J,2);i(D,{type:"multi",children:(t,a)=>{o();var e=l();e.nodeValue=`const user = {
    name: "Ravi",
    age: 25,
...
console.log(jsonS);`,s(t,e)},$$slots:{default:!0}});var I=r(D,4);i(I,{hideCopyButton:!0,code:'{"name":"Ravi","age":25,"profession":"Web Developer"}'});var B=r(I,4);u(B,{id:"modifyingDataJavaScript",children:(t,a)=>{var e=ue();s(t,e)},$$slots:{default:!0}});var b=r(B,2),L=r(c(b));v(L,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-check-if-a-string-is-a-valid-json-string/",children:(t,a)=>{o();var e=l("JSON строку");s(t,e)},$$slots:{default:!0}});var le=r(L,2);v(le,{visited:!0,href:"https://www.geeksforgeeks.org/objects-in-javascript/",children:(t,a)=>{o();var e=l("JavaScript объект");s(t,e)},$$slots:{default:!0}}),o(),$(b);var E=r(b,2);i(E,{type:"multi",children:(t,a)=>{o();var e=l();e.nodeValue=`const json = '{"name": "Ravi", "age": 25}';
const obj = JSON.parse(json);

obj.profession = "Web Developer";
console.log(JSON.stringify(obj));`,s(t,e)},$$slots:{default:!0}});var U=r(E,4);i(U,{hideCopyButton:!0,code:'{"name":"Ravi","age":25,"profession":"Web Developer"}'});var W=r(U,4);u(W,{id:"filteringATransformationJavaScript",children:(t,a)=>{var e=he();s(t,e)},$$slots:{default:!0}});var O=r(W,2),z=r(c(O));v(z,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-array-filter-method/",children:(t,a)=>{o();var e=l("filter()");s(t,e)},$$slots:{default:!0}});var H=r(z,2);v(H,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-array-map-method/",children:(t,a)=>{o();var e=l("map()");s(t,e)},$$slots:{default:!0}});var ie=r(H,2);v(ie,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-array-reduce-method/",children:(t,a)=>{o();var e=l("reduce()");s(t,e)},$$slots:{default:!0}}),o(),$(O);var K=r(O,6);i(K,{type:"multi",children:(t,a)=>{o();var e=l();e.nodeValue=`const users = [
    { "name": "Amit", "age": 24 },
    { "name": "Rahul", "age": 45 },
    { "name": "Priya", "age": 30 }
];
...
console.log(olderThan30);`,s(t,e)},$$slots:{default:!0}});var q=r(K,4);u(q,{id:"SerializationJavaScript",children:(t,a)=>{var e=fe();s(t,e)},$$slots:{default:!0}});var F=r(q,4);i(F,{type:"multi",children:(t,a)=>{o();var e=l();e.nodeValue=`const user = {
    name: "Simran",
    age: 29
};

const jsonS = JSON.stringify(user);
console.log(jsonS);`,s(t,e)},$$slots:{default:!0}});var G=r(F,4);i(G,{hideCopyButton:!0,code:'{"name":"Simran","age":29}'});var M=r(G,4);u(M,{id:"CustomizingSerializationJavaScript",children:(t,a)=>{var e=_e();s(t,e)},$$slots:{default:!0}});var N=r(M,2),ne=c(N);v(ne,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-json-stringify-method/",children:(t,a)=>{o();var e=l("JSON.stringify()");s(t,e)},$$slots:{default:!0}}),o(),$(N);var Q=r(N,2);i(Q,{type:"multi",children:(t,a)=>{o();var e=l();e.nodeValue=`const user = {
    name: "Jatin",
    age: 32,
    password: "123456"
};
...
fetch('your-api-url', {
    ...
    .catch(error => console.error('Error:', error));`,s(t,e)},$$slots:{default:!0}});var ve=r(ee,6);te(ve,{style:"margin-left: 3.5em;",children:(t,a)=>{var e=Oe(),_=w(e);f(_,{children:(p,j)=>{var d=Se();o(),s(p,d)},$$slots:{default:!0}});var g=r(_,2);f(g,{children:(p,j)=>{var d=me();o(),s(p,d)},$$slots:{default:!0}});var h=r(g,2);f(h,{children:(p,j)=>{var d=Je();o(),s(p,d)},$$slots:{default:!0}});var y=r(h,2);f(y,{children:(p,j)=>{var d=be();o(),s(p,d)},$$slots:{default:!0}}),s(t,e)},$$slots:{default:!0}}),s(re,x)}export{Re as component};
