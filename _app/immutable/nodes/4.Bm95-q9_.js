...
}`,o(t,e)},$$slots:{default:!0}});var m=s(C,6),X=s(c(m));p(X,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-json-stringify-method/",children:(t,l)=>{r();var e=a("JSON.stringify()");o(t,e)},$$slots:{default:!0}}),r(),d(m);var R=s(m,2);i(R,{type:"multi",children:(t,l)=>{r();var e=a();e.nodeValue=`const user = {
    name: "Ravi",
    age: 25,
...
console.log(jsonS);`,o(t,e)},$$slots:{default:!0}});var V=s(R,4);i(V,{hideCopyButton:!0,code:'{"name":"Ravi","age":25,"profession":"Web Developer"}'});var b=s(V,6),D=s(c(b));p(D,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-check-if-a-string-is-a-valid-json-string/",children:(t,l)=>{r();var e=a("JSON строку");o(t,e)},$$slots:{default:!0}});var Y=s(D,2);p(Y,{visited:!0,href:"https://www.geeksforgeeks.org/objects-in-javascript/",children:(t,l)=>{r();var e=a("JavaScript объект");o(t,e)},$$slots:{default:!0}}),r(),d(b);var I=s(b,2);i(I,{type:"multi",children:(t,l)=>{r();var e=a();e.nodeValue=`const json = '{"name": "Ravi", "age": 25}';
const obj = JSON.parse(json);

obj.profession = "Web Developer";
console.log(JSON.stringify(obj));`,o(t,e)},$$slots:{default:!0}});var T=s(I,4);i(T,{hideCopyButton:!0,code:'{"name":"Ravi","age":25,"profession":"Web Developer"}'});var _=s(T,6),B=s(c(_));p(B,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-array-filter-method/",children:(t,l)=>{r();var e=a("filter()");o(t,e)},$$slots:{default:!0}});var L=s(B,2);p(L,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-array-map-method/",children:(t,l)=>{r();var e=a("map()");o(t,e)},$$slots:{default:!0}});var Z=s(L,2);p(Z,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-array-reduce-method/",children:(t,l)=>{r();var e=a("reduce()");o(t,e)},$$slots:{default:!0}}),r(),d(_);var E=s(_,6);i(E,{type:"multi",children:(t,l)=>{r();var e=a();e.nodeValue=`const users = [
    { "name": "Amit", "age": 24 },
    { "name": "Rahul", "age": 45 },
    { "name": "Priya", "age": 30 }
];
...
console.log(olderThan30);`,o(t,e)},$$slots:{default:!0}});var W=s(E,8);i(W,{type:"multi",children:(t,l)=>{r();var e=a();e.nodeValue=`const user = {
    name: "Simran",
    age: 29
};

const jsonS = JSON.stringify(user);
console.log(jsonS);`,o(t,e)},$$slots:{default:!0}});var z=s(W,4);i(z,{hideCopyButton:!0,code:'{"name":"Simran","age":29}'});var O=s(z,6),ee=c(O);p(ee,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-json-stringify-method/",children:(t,l)=>{r();var e=a("JSON.stringify()");o(t,e)},$$slots:{default:!0}}),r(),d(O);var U=s(O,2);i(U,{type:"multi",children:(t,l)=>{r();var e=a();e.nodeValue=`const user = {
    name: "Jatin",
    age: 32,
    password: "123456"
};
...
console.log(jsonS);`,o(t,e)},$$slots:{default:!0}});var H=s(U,4);i(H,{hideCopyButton:!0,code:'{"name":"Jatin","age":32}'});var N=s(H,6),te=s(c(N));p(te,{visited:!0,href:"https://www.geeksforgeeks.org/how-to-master-json-in-javascript/",children:(t,l)=>{r();var e=a("JavaScript fetch() API");o(t,e)},$$slots:{default:!0}}),r(),d(N);var q=s(N,4);i(q,{type:"multi",children:(t,l)=>{r();var e=a();e.nodeValue=`fetch('your-api-url')
    .then(response => response.json())
    .then(data => console.log(data))
    .catch(error => console.error('Error:', error));`,o(t,e)},$$slots:{default:!0}});var F=s(q,6);i(F,{type:"multi",children:(t,l)=>{r();var e=a();e.nodeValue=`const pData = {
    name: "Ravi",
    age: 25
};
...
fetch('your-api-url', {
    ...
    .catch(error => console.error('Error:', error));`,o(t,e)},$$slots:{default:!0}});var se=s(F,6);G(se,{style:"margin-left: 3.5em;",children:(t,l)=>{var e=ne(),f=P(e);h(f,{children:(n,j)=>{var v=oe();r(),o(n,v)},$$slots:{default:!0}});var g=s(f,2);h(g,{children:(n,j)=>{var v=ae();r(),o(n,v)},$$slots:{default:!0}});var $=s(g,2);h($,{children:(n,j)=>{var v=le();r(),o(n,v)},$$slots:{default:!0}});var y=s($,2);h(y,{children:(n,j)=>{var v=ie();r(),o(n,v)},$$slots:{default:!0}}),o(t,e)},$$slots:{default:!0}}),o(K,w)}export{Se as component};
