...
echo $json;
exit();
`,o(t,e)},$$slots:{default:!0}});var P=s(j,2);u(P,{id:"decoding",children:(t,r)=>{var e=k();o(t,e)},$$slots:{default:!0}});var d=s(P,2),H=s($(d));R(H,{visited:!0,href:"https://www.php.net/manual/ru/function.json-decode.php",children:(t,r)=>{a();var e=l("json_decode($json)");o(t,e)},$$slots:{default:!0}}),a(),i(d);var T=s(d,2);_(T,{type:"multi",children:(t,r)=>{a();var e=l();e.nodeValue=`$json = '{"1":"Значение 1","2":"Значение 2","3":"Значение 3","4":"Значение 4","5":"Значение 5"}';
...
`,o(t,e)},$$slots:{default:!0}}),o(L,O)}export{q as component};
