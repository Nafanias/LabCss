...
`,o(t,e)},$$slots:{default:!0}});var v=r(m,4);s(v,{hideCopyButton:!0,code:"using JsonDocument doc = JsonDocument.Parse(data);"});var $=r(v,4);s($,{hideCopyButton:!0,code:"JsonElement root = doc.RootElement;"});var h=r($,4);s(h,{type:"multi",hideCopyButton:!0,showMoreLess:!1,children:(t,n)=>{i();var e=a();e.nodeValue=`var u1 = root[0];
var u2 = root[1];
Console.WriteLine(u1);
Console.WriteLine(u2);
...
Peter Novak
driver
`,o(t,e)},$$slots:{default:!0}});var S=r(y,2);u(S,{id:"enumerateJsonScarp",children:(t,n)=>{var e=Z();o(t,e)},$$slots:{default:!0}});var f=r(S,4);s(f,{type:"multi",children:(t,n)=>{i();var e=a();e.nodeValue=`using System.Text.Json;
...
`,o(t,e)},$$slots:{default:!0}});var _=r(f,4);s(_,{hideCopyButton:!0,code:"var users = root.EnumerateArray();"});var g=r(_,4);s(g,{type:"multi",hideCopyButton:!0,showMoreLess:!1,children:(t,n)=>{i();var e=a();e.nodeValue=`while (users.MoveNext())
{
 var user = users.Current;
 Console.WriteLine(user);
...
`,o(t,e)},$$slots:{default:!0}});var N=r(g,4);s(N,{type:"multi",hideCopyButton:!0,showMoreLess:!1,children:(t,n)=>{i();var e=a();e.nodeValue=`var props = user.EnumerateObject();
...
`,o(t,e)},$$slots:{default:!0}});var C=r(N,4);s(C,{type:"multi",hideCopyButton:!0,showMoreLess:!1,children:(t,n)=>{i();var e=a();e.nodeValue=`$ dotnet run
{"name": "John Doe", "occupation": "gardener"}
name: John Doe
occupation: gardener
{"name": "Peter Novak", "occupation": "driver"}
name: Peter Novak
occupation: driver
`,o(t,e)},$$slots:{default:!0}});var P=r(C,2);u(P,{id:"serializeJsonScarp",children:(t,n)=>{var e=ee();o(t,e)},$$slots:{default:!0}});var w=r(P,4);s(w,{type:"multi",children:(t,n)=>{i();var e=a();e.nodeValue=`using System.Text.Json;
...
`,o(t,e)},$$slots:{default:!0}});var x=r(O,2);u(x,{id:"deserializeJsonScarp",children:(t,n)=>{var e=te();o(t,e)},$$slots:{default:!0}});var L=r(x,4);s(L,{type:"multi",children:(t,n)=>{i();var e=a();e.nodeValue=`using System.Text.Json;
...
`,o(t,e)},$$slots:{default:!0}});var W=r(L,4);u(W,{id:"JsonSerializerOptionsJsonScarp",children:(t,n)=>{var e=re();o(t,e)},$$slots:{default:!0}});var T=r(W,4);s(T,{type:"multi",children:(t,n)=>{i();var e=a();e.nodeValue=`using System.Text.Json;
...
5: forest
6: warm
`,o(t,e)},$$slots:{default:!0}});var U=r(D,2);u(U,{id:"Utf8JsonWriterJsonScarp",children:(t,n)=>{var e=oe();o(t,e)},$$slots:{default:!0}});var E=r(U,4);s(E,{type:"multi",children:(t,n)=>{i();var e=a();e.nodeValue=`using System.Text.Json;
using System.Text;
...
Console.WriteLine(json);
`,o(t,e)},$$slots:{default:!0}});var k=r(E,4);s(k,{type:"multi",hideCopyButton:!0,showMoreLess:!1,children:(t,n)=>{i();var e=a();e.nodeValue=`$ dotnet run
{"name":"John Doe","occupation":"gardener","age":34}
`,o(t,e)},$$slots:{default:!0}});var V=r(k,4);s(V,{type:"multi",children:(t,n)=>{i();var e=a();e.nodeValue=`using System.Text.Json;
...
jdoc.WriteTo(writer);
`,o(t,e)},$$slots:{default:!0}});var b=r(V,4);s(b,{type:"multi",hideCopyButton:!0,showMoreLess:!1,children:(t,n)=>{i();var e=a();e.nodeValue=`$ cat data.json 
[
 {
 "name": "John Doe",
 "occupation": "gardener"
...
`,o(t,e)},$$slots:{default:!0}});var A=r(b,2);u(A,{id:"Utf8JsonReaderJsonScarp",children:(t,n)=>{var e=ne();o(t,e)},$$slots:{default:!0}});var M=r(A,4);s(M,{type:"multi",children:(t,n)=>{i();var e=a();e.nodeValue=`using System.Text.Json;
...
`,o(t,e)},$$slots:{default:!0}});var B=r(M,4);s(B,{type:"multi",hideCopyButton:!0,showMoreLess:!1,children:(t,n)=>{i();var e=a();e.nodeValue=`$ dotnet run
-------------
name: John Doe
occupation: gardener
-------------
name: Peter Novak
occupation: driver
`,o(t,e)},$$slots:{default:!0}});var G=r(B,2);u(G,{id:"ParseAsyncJsonScarp",children:(t,n)=>{var e=se();o(t,e)},$$slots:{default:!0}});var j=r(G,4);s(j,{type:"multi",children:(t,n)=>{i();var e=a();e.nodeValue=`using System.Text.Json;
...
`,o(t,e)},$$slots:{default:!0}});var z=r(j,4);u(z,{id:"GetFromJsonAsyncJsonScarp",children:(t,n)=>{var e=ae();o(t,e)},$$slots:{default:!0}});var F=r(z,6);s(F,{type:"multi",children:(t,n)=>{i();var e=a();e.nodeValue=`using System.Text.Json.Serialization;
...
`,o(t,e)},$$slots:{default:!0}});var H=r(I,10);s(H,{type:"multi",children:(t,n)=>{i();var e=a();e.nodeValue=`
`,o(t,e)},$$slots:{default:!0}});var K=r(H,2);s(K,{type:"multi",hideCopyButton:!0,showMoreLess:!1,children:(t,n)=>{i();var e=a();e.nodeValue=`
`,o(t,e)},$$slots:{default:!0}}),o(q,d)}export{me as component};
