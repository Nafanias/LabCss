...
print_r($array);
`,o(t,e)},$$slots:{default:!0}});var J=s(T,4);_(J,{type:"multi",hideCopyButton:!0,children:(t,r)=>{a();var e=l();e.nodeValue=`stdClass Object
(
	[1] => Значение 1
	[2] => Значение 2
	[3] => Значение 3
...
`,o(t,e)},$$slots:{default:!0}});var x=s(J,4);_(x,{type:"multi",children:(t,r)=>{a();var e=l();e.nodeValue=`$json = '{"1":"Значение 1","2":"Значение 2","3":"Значение 3","4":"Значение 4","5":"Значение 5"}';
$array = json_decode($json, true);
print_r($array);
`,o(t,e)},$$slots:{default:!0}});var f=s(x,4);_(f,{type:"multi",hideCopyButton:!0,children:(t,r)=>{a();var e=l();e.nodeValue=`Array
(
	[1] => Значение 1
	[2] => Значение 2
	[3] => Значение 3
...
`,o(t,e)},$$slots:{default:!0}});var m=s(y,4);_(m,{type:"multi",children:(t,r)=>{a();var e=l();e.nodeValue=`$constants = get_defined_constants(true);
foreach ($constants['json'] as $name => $value) {
	echo $name . ': ' . $value . '<br>';
}
`,o(t,e)},$$slots:{default:!0}});var A=s(m,4);_(A,{type:"multi",hideCopyButton:!0,children:(t,r)=>{a();var e=l();e.nodeValue=`JSON_HEX_TAG: 1
JSON_HEX_AMP: 2
JSON_HEX_APOS: 4
JSON_HEX_QUOT: 8
...
JSON_ERROR_UTF16: 10
`,o(t,e)},$$slots:{default:!0}});var p=s(A,2),V=s($(p));R(V,{visited:!0,href:"https://snipp.ru/handbk/table-ascii#link-upravlyayuschie-simvoly",children:(t,r)=>{a();var e=l("управляющие символы");o(t,e)},$$slots:{default:!0}}),a(),i(p);var U=s(p,2);_(U,{type:"multi",children:(t,r)=>{a();var e=l();e.nodeValue=`$json = '{...}';
...
$res = curl_exec($ch);
curl_close($ch);
`,o(t,e)},$$slots:{default:!0}});var D=s(I,4);_(D,{type:"multi",children:(t,r)=>{a();var e=l();e.nodeValue=`$data = file_get_contents('php://input');
$data = json_decode($data, true);
`,o(t,e)},$$slots:{default:!0}}),o(b,O)}export{W as component};
