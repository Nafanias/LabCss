...
JSON_ERROR_UTF16: 10
`,r(t,e)},$$slots:{default:!0}});var c=s(J,2),U=s(p(c));$(U,{visited:!0,href:"https://snipp.ru/handbk/table-ascii#link-upravlyayuschie-simvoly",children:(t,l)=>{o();var e=a("управляющие символы");r(t,e)},$$slots:{default:!0}}),o(),d(c);var f=s(c,2);_(f,{type:"multi",children:(t,l)=>{o();var e=a();e.nodeValue=`$json = '{...}';
...
print_r($res);
`,r(t,e)},$$slots:{default:!0}});var C=s(f,6);_(C,{type:"multi",children:(t,l)=>{o();var e=a();e.nodeValue=`$data = array(
	'name' => 'snipp.ru'
...
$res = curl_exec($ch);
curl_close($ch);
`,r(t,e)},$$slots:{default:!0}});var z=s(C,4);_(z,{type:"multi",children:(t,l)=>{o();var e=a();e.nodeValue=`$data = file_get_contents('php://input');
