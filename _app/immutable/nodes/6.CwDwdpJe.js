...
print("
Type of data")
print(type(employee_dict))`,r(e,t)},$$slots:{default:!0}});var b=s(y,2);l(b,{type:"multi",children:(e,n)=>{o();var t=a();t.nodeValue=`Данные после конвертации
{'имя': 'Нитин', 'отдел': 'Финансы', 'компания': 'GFG'}
Финансы

Тип данных
<класс 'dict'>
	`,r(e,t)},$$slots:{default:!0}});var f=s(b,8);l(f,{type:"multi",children:(e,n)=>{o();var t=a();t.nodeValue=`# Import required libraries
import json
...
]`,r(e,t)},$$slots:{default:!0}}),r(P,m)}export{T as component};
