...
}`,r(s,e)},$$slots:{default:!0}});var R=t(C,4);u(R,{id:"stringifyingJavaScript",children:(s,o)=>{var e=$e();r(s,e)},$$slots:{default:!0}});var m=t(R,2),oe=t(c(m));i(oe,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-json-stringify-method/",children:(s,o)=>{a();var e=l("JSON.stringify()");r(s,e)},$$slots:{default:!0}}),a(),$(m);var V=t(m,2);n(V,{type:"multi",children:(s,o)=>{a();var e=l();e.nodeValue=`const user = {
    name: "Ravi",
    age: 25,
...
console.log(olderThan30);`,r(s,e)},$$slots:{default:!0}});var F=t(H,4);u(F,{id:"SerializationJavaScript",children:(s,o)=>{var e=he();r(s,e)},$$slots:{default:!0}});var G=t(F,4);n(G,{type:"multi",children:(s,o)=>{a();var e=l();e.nodeValue=`const user = {
    name: "Simran",
    age: 29
};

const jsonS = JSON.stringify(user);
console.log(jsonS);`,r(s,e)},$$slots:{default:!0}});var K=t(G,4);n(K,{hideCopyButton:!0,code:'{"name":"Simran","age":29}'});var M=t(K,4);u(M,{id:"CustomizingSerializationJavaScript",children:(s,o)=>{var e=fe();r(s,e)},$$slots:{default:!0}});var N=t(M,2),de=c(N);i(de,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-json-stringify-method/",children:(s,o)=>{a();var e=l("JSON.stringify()");r(s,e)},$$slots:{default:!0}}),a(),$(N);var Q=t(N,2);n(Q,{type:"multi",children:(s,o)=>{a();var e=l();e.nodeValue=`const user = {
    name: "Jatin",
    age: 32,
    password: "123456"
};
...
fetch('your-api-url', {
    ...
    .catch(error => console.error('Error:', error));`,r(s,e)},$$slots:{default:!0}});var ie=t(ee,6);se(ie,{style:"margin-left: 3.5em;",children:(s,o)=>{var e=Oe(),f=j(e);h(f,{children:(p,y)=>{var v=qe();a(),r(p,v)},$$slots:{default:!0}});var _=t(f,2);h(_,{children:(p,y)=>{var v=Se();a(),r(p,v)},$$slots:{default:!0}});var g=t(_,2);h(g,{children:(p,y)=>{var v=me();a(),r(p,v)},$$slots:{default:!0}});var P=t(g,2);h(P,{children:(p,y)=>{var v=Je();a(),r(p,v)},$$slots:{default:!0}}),r(s,e)},$$slots:{default:!0}}),r(te,w)}export{Ae as component};
