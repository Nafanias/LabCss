...
}`,o(t,e)},$$slots:{default:!0}});var m=s(V,6),X=s(d(m));p(X,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-json-stringify-method/",children:(t,l)=>{r();var e=a("JSON.stringify()");o(t,e)},$$slots:{default:!0}}),r(),c(m);var C=s(m,2);i(C,{type:"multi",children:(t,l)=>{r();var e=a();e.nodeValue=`const user = {
    name: "Ravi",
    age: 25,
...
console.log(jsonS);`,o(t,e)},$$slots:{default:!0}});var R=s(C,4);i(R,{hideCopyButton:!0,code:'{"name":"Ravi","age":25,"profession":"Web Developer"}'});var b=s(R,6),T=s(d(b));p(T,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-check-if-a-string-is-a-valid-json-string/",children:(t,l)=>{r();var e=a("JSON строку");o(t,e)},$$slots:{default:!0}});var Y=s(T,2);p(Y,{visited:!0,href:"https://www.geeksforgeeks.org/objects-in-javascript/",children:(t,l)=>{r();var e=a("JavaScript объект");o(t,e)},$$slots:{default:!0}}),r(),c(b);var D=s(b,2);i(D,{type:"multi",children:(t,l)=>{r();var e=a();e.nodeValue=`const json = '{"name": "Ravi", "age": 25}';
const obj = JSON.parse(json);

obj.profession = "Web Developer";
console.log(JSON.stringify(obj));`,o(t,e)},$$slots:{default:!0}});var I=s(D,4);i(I,{hideCopyButton:!0,code:'{"name":"Ravi","age":25,"profession":"Web Developer"}'});var _=s(I,6),B=s(d(_));p(B,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-array-filter-method/",children:(t,l)=>{r();var e=a("filter()");o(t,e)},$$slots:{default:!0}});var L=s(B,2);p(L,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-array-map-method/",children:(t,l)=>{r();var e=a("map()");o(t,e)},$$slots:{default:!0}});var Z=s(L,2);p(Z,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-array-reduce-method/",children:(t,l)=>{r();var e=a("reduce()");o(t,e)},$$slots:{default:!0}}),r(),c(_);var E=s(_,6);i(E,{type:"multi",children:(t,l)=>{r();var e=a();e.nodeValue=`const users = [
    { "name": "Amit", "age": 24 },
    { "name": "Rahul", "age": 45 },
    { "name": "Priya", "age": 30 }
];
...
console.log(olderThan30);`,o(t,e)},$$slots:{default:!0}});var U=s(E,8);i(U,{type:"multi",children:(t,l)=>{r();var e=a();e.nodeValue=`const user = {
    name: "Simran",
    age: 29
};

const jsonS = JSON.stringify(user);
console.log(jsonS);`,o(t,e)},$$slots:{default:!0}});var W=s(U,4);i(W,{hideCopyButton:!0,code:'{"name":"Simran","age":29}'});var O=s(W,6),ee=d(O);p(ee,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-json-stringify-method/",children:(t,l)=>{r();var e=a("JSON.stringify()");o(t,e)},$$slots:{default:!0}}),r(),c(O);var z=s(O,2);i(z,{type:"multi",children:(t,l)=>{r();var e=a();e.nodeValue=`const user = {
    name: "Jatin",
    age: 32,
    password: "123456"
};
...
console.log(jsonS);`,o(t,e)},$$slots:{default:!0}});var H=s(z,4);i(H,{hideCopyButton:!0,code:'{"name":"Jatin","age":32}'});var N=s(H,6),te=s(d(N));p(te,{visited:!0,href:"https://www.geeksforgeeks.org/how-to-master-json-in-javascript/",children:(t,l)=>{r();var e=a("JavaScript fetch() API");o(t,e)},$$slots:{default:!0}}),r(),c(N);var K=s(N,4);i(K,{type:"multi",children:(t,l)=>{r();var e=a();e.nodeValue=`fetch('your-api-url')
    .then(response => response.json())
    .then(data => console.log(data))
    .catch(error => console.error('Error:', error));`,o(t,e)},$$slots:{default:!0}});var q=s(K,6);i(q,{type:"multi",children:(t,l)=>{r();var e=a();e.nodeValue=`const pData = {
    name: "Ravi",
    age: 25
};
...
fetch('your-api-url', {
    ...
    .catch(error => console.error('Error:', error));`,o(t,e)},$$slots:{default:!0}});var se=s(q,6);F(se,{style:"margin-left: 3.5em;",children:(t,l)=>{var e=ne(),f=P(e);h(f,{children:(n,j)=>{var v=oe();r(),o(n,v)},$$slots:{default:!0}});var g=s(f,2);h(g,{children:(n,j)=>{var v=ae();r(),o(n,v)},$$slots:{default:!0}});var $=s(g,2);h($,{children:(n,j)=>{var v=le();r(),o(n,v)},$$slots:{default:!0}});var y=s($,2);h(y,{children:(n,j)=>{var v=ie();r(),o(n,v)},$$slots:{default:!0}}),o(t,e)},$$slots:{default:!0}}),o(G,w)}export{Se as component};
