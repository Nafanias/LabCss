...
}`,o(t,e)},$$slots:{default:!0}});var m=s(V,6),Q=s(d(m));p(Q,{visited:!0,href:"https://www.geeksforgeeks.org/javascript-json-stringify-method/",children:(t,l)=>{r();var e=a("JSON.stringify()");o(t,e)},$$slots:{default:!0}}),r(),c(m);var C=s(m,2);i(C,{type:"multi",children:(t,l)=>{r();var e=a();e.nodeValue=`const user = {
    name: "Ravi",
    age: 25,
...
fetch('your-api-url', {
    ...
    .catch(error => console.error('Error:', error));`,o(t,e)},$$slots:{default:!0}});var se=s(X,6);q(se,{style:"margin-left: 3.5em;",children:(t,l)=>{var e=ne(),f=P(e);h(f,{children:(n,j)=>{var v=oe();r(),o(n,v)},$$slots:{default:!0}});var g=s(f,2);h(g,{children:(n,j)=>{var v=ae();r(),o(n,v)},$$slots:{default:!0}});var $=s(g,2);h($,{children:(n,j)=>{var v=le();r(),o(n,v)},$$slots:{default:!0}});var y=s($,2);h(y,{children:(n,j)=>{var v=ie();r(),o(n,v)},$$slots:{default:!0}}),o(t,e)},$$slots:{default:!0}}),o(F,w)}export{Se as component};
